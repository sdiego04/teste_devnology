    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="/cadastroModelo">Novo Modelo</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="row g-2">
    <div class="col-sm input-group">
        ...
        <input type="text" class="input-group form-control" value="{{$lista->modelo}}" aria-label="City" readonly>
    </div>
</div>
<div class="col-sm input-group form-control">
    <form method="post" action="/removerModelo/{{$lista->id}}" class="form-control">
        <button class="form-control btn-danger">Deletar</button>
        @csrf
    </form>
    <form method="get" action="/formAlterarModelo/{{$lista->id}}+{{$lista->modelo}}" class="form-control">
